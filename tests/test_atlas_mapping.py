...
class ImplicitSinkhornTest(unittest.TestCase):
    def test_float32_storage_underflow_uses_log_domain_float64_reference(self) -> None:
        ...
        self.assertLess(diagnostics.storage_underflow_mass_fraction, 1.0e-30)
        self.assertLess(diagnostics.storage_zero_source_mass_fraction, 1.0e-30)
        self.assertLess(diagnostics.storage_zero_target_mass_fraction, 1.0e-30)
        self.assertLess(diagnostics.storage_relative_l1_error, 1.0e-7)
